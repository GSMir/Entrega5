...
```{r}
europa = read.table("europa.dat", sep = " ")
europa_tipi = scale(europa)

descomp = svd(europa_tipi)
...
fig <- plot_ly(x=a_1, y=a_2, z=a_3, type="scatter3d", mode="markers", color=a_3, text = rownames(data)) %>% 
  layout(scene = list(xaxis = list(title='CP1'), yaxis = list(title='CP2'), zaxis = list(title='CP3')))
fig
```
